  ...
  const serviceInfo = [
    {
      ...
      name: "Round Trip",
      description:
        "If Our Customers Want to Return With Our Service They Could Get Round Trip",
      icon: airplane,
      direction:'left'
    },

    {
      ...
      name: "Hotel",
      description:
        "We Provide to Our Customers 5 Star Hotel. Nothing to think about Hotel",
      icon: hotel,
    },
    {
      id: 2,
      name: "Car",
      description: "Our Customer Will Get Car Convenience to Ride Everywhere",
      icon: car,
      direction:'right'
    },
  ];
